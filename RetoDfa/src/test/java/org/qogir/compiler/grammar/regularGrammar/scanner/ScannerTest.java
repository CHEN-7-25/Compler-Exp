...
public class ScannerTest {
    ...
    public void testConstructNFA(){
        String[] regexes = new String[]{"regex0 := c(a|b)*"};//"regex0 := c(a|b)*", "regex1 := c(a|b)*", "regex2 := d(f|ea*(g|h))b","c(a|b)*","a|b", "ab*", "d(f|e)","d(f|ea*(g|h))b","c(a|b)*"
    ...
    public void testConstructDFA() {
        ...
        //test building a grammar for the grammar
        Scanner scanner = new Scanner(rg);
        RDFA dfa = scanner.constructDFA(scanner.constructNFA());

        //test constructing the DFA
        System.out.println("Show the DFA:");
        System.out.println(dfa.toString());
        System.out.println("Show the mapping between DFA and NFA:");
    ...
    public void testConstructMinDFA() {
        ...
        //test building a grammar for the grammar
        Scanner scanner = new Scanner(rg);
        RDFA minDFA = scanner.minimizeDFA(scanner.constructDFA(scanner.constructNFA()));
